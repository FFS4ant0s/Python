...
CAMINHO_HTML = pathlib.Path(__file__).parent / 'aula131.html'

# Dados do remetente e destinatário
remetente = os.getenv('nandopython@outlook.com', '')
destinatario = remetente

# Configurações SMTP
smtp_server = 'smtp-mail.outlook.com'
smtp_port = 587
smtp_username = os.getenv('nandopython@outlook.com', '')
smtp_password = os.getenv('Nando@123', '')
