...
print(os.path.basename(diretorio)) # é uma função que retorna o nome do arquivo ou diretório baseado no caminho.
print(os.path.dirname(caminho)) # é uma função que retorna o diretório pai de um caminho (path)